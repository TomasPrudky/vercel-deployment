...
// sourceA = Fantasy Premier League ID
// sourceB = World Fantasy Soccer (Serie A) ID
...
// Player ID with bonus points in Serie A
export const BONUS_PLAYER_ID = 0;
export const BONUS_POINTS = 0;
